...
def build_admin_router(
    ...
    if review_workflow is not None:
        ...
        from .admin_o07_o08 import register_o07_o08_routes

        register_o07_o08_routes(router, review_workflow, principal_dependency)

        from .admin_o04 import register_o04_routes

        register_o04_routes(router, review_workflow, principal_dependency)

        from .admin_o05 import register_o05_routes
