...
class RevisionLifecycleCatalogRepository(Protocol):
...
class RevisionLifecycleRepository(Protocol):
    def get_revision(self, revision_id: str) -> PlaceRevision | None: ...
    def get_latest_revision(self, place_id: str) -> PlaceRevision | None: ...
    def get_open_task_for_revision(self, revision_id: str) -> PlaceReviewTask | None: ...
    def add_revision(self, revision: PlaceRevision) -> None: ...
...
class RevisionLifecycleUnitOfWork(AuditContext, Protocol):
    @property
    def reviews(self) -> RevisionLifecycleRepository: ...
    @property
    def catalog(self) -> RevisionLifecycleCatalogRepository: ...
    def __enter__(self) -> Self: ...
    def __exit__(
        self,
        exc_type: type[BaseException] | None,
