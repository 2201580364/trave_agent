...
> 历史账本切片，只读存档。覆盖 2026-08-24 至 2026-08-31 的续接记录，以及截至 2026-09-02 的「当前总状态/已完成/正在进行/明确未完成」结构快照与术语表。文中「当前节点」「最新测试基线」均为当时快照（后续轮次已覆盖），最新状态见 [../CURRENT.md](../CURRENT.md)。内容自原 project-status.md 原样搬运，未改写语义。
