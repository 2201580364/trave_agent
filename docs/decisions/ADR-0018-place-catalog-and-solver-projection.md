...
> 2026-09-10：本 ADR 的唯一固定场次限制及多场次拒绝条款已由 [ADR-0025](ADR-0025-show-sessions-and-candidate-time-rule-deletion.md) 替代；其余决策保留。
- **状态**：已接受
- **日期**：2026-08-29
- **决策者**：产品 + 工程
- **产品里程碑**：M1 — 行程骨架验证
...
> 后续顺序增量：ADR-0019 已将原 R0.2-05 细分为 `05-01 管理身份/API/审计`、`05-02 地点审核工作台`、`05-03 采集与人工审核`，并把 R0.2-07 扩展为 OM1 发布中心与快照发布。本 ADR 的 Place/投影语义不变。
