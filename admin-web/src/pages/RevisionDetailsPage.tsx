import { RevisionPublicationReadiness } from './RevisionPublicationReadiness'
...
import { RevisionProfileCard } from './RevisionProfileCard'
    ...
    <Space orientation="vertical" size="large" style={{ width: '100%' }}>
      ...
      {revision !== null && (
        <>
          ...
          <RevisionProfileCard revision={revision} />
          ...
          <RevisionPublicationReadiness blockers={blockers} publicationCheck={publicationCheck} publicationCheckError={publicationCheckError} />
        </>
      )}
